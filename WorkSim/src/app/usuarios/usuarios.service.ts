...
export class UsuariosService {
  ...
  public obterColaboradores(filtros: IUsuarios): Observable<any> {
    this.http.autorizationHeader = true;
  ...
  public obterColaborador(id: number): Observable<any> {
    this.http.autorizationHeader = true;
  ...
  public editarColaborador(usuario: IUsuarios): Observable<any> {
    this.http.autorizationHeader = true;

    return this.http.post(`api/usuario/${usuario.id}/editar`, usuario)
      .map((response) => {
        return response
      });
  }

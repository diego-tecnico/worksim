...
var PesquisarChamadosComponent = /** @class */ (function () {
    ...
    PesquisarChamadosComponent.prototype.obterUsuarios = function () {
        var _this = this;
    ...
    PesquisarChamadosComponent.prototype.obterSetores = function () {
        var _this = this;
        this.pesquisarChamadosService.obterSetores()
            .subscribe(function (x) {
            _this.setores = x.setores;
            console.log(_this.setores);
        });
    };
    PesquisarChamadosComponent.prototype.obterCategoria = function () {
        var _this = this;
        this.pesquisarChamadosService.obterCategoria(1)
            .subscribe(function (x) {
            _this.categorias = x.categorias;
